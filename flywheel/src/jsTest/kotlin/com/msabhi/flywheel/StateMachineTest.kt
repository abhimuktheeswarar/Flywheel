...
class StateMachineTest {
    ...
    @Test
    fun materialStateMachineTest() = runTest(UnconfinedTestDispatcher()) {
    ...
    @Test
    fun stateMutabilityTest() = runTest(UnconfinedTestDispatcher()) {
    ...
    @Test
    fun invalidActionForStateTest() = runTest(UnconfinedTestDispatcher()) {
        val scope = TestScope(SupervisorJob() + UnconfinedTestDispatcher())
        val stateReserve =
            getStateReserve(
                scope = scope,
