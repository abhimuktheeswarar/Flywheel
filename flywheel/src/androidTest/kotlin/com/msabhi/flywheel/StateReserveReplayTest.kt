...
class StateReserveReplayTest {
    ...
    /**
     * Tests that cancellation during first emit in StateReserve .State flow doesn't block other collectors forever
     * Will fail if stateChannel subscription will be collected without finally block in StateReserve.flow builder
     */
