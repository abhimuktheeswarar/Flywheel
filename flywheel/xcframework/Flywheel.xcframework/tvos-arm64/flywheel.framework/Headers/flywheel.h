...
@class FlywheelActionStateAlways<__covariant A, __covariant S>, FlywheelActionStateOnEnter<__covariant A, __covariant S>, FlywheelActionStateOnExit<__covariant A, __covariant S>, FlywheelKotlinException, FlywheelInitialState<S>, FlywheelStateReserveConfig, FlywheelKotlinUnit, FlywheelTransitionInValid<__covariant A, __covariant S>, FlywheelTransitionNothing<__covariant A, __covariant S>, FlywheelTransitionValid<__covariant A, __covariant FS, __covariant TS>, FlywheelKotlinThrowable, FlywheelKotlinArray<T>, FlywheelMutableStateCheckerStateWrapper<S>, FlywheelKotlinx_coroutines_coreCoroutineDispatcher, FlywheelStateReserve<S>, FlywheelMutableStateChecker<S>, FlywheelKotlinCancellationException, FlywheelKotlinRuntimeException, FlywheelKotlinIllegalStateException, FlywheelKotlinAbstractCoroutineContextElement, FlywheelKotlinx_coroutines_coreAtomicDesc, FlywheelKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, FlywheelKotlinx_coroutines_coreAtomicOp<__contravariant T>, FlywheelKotlinx_coroutines_coreOpDescriptor, FlywheelKotlinx_coroutines_coreLockFreeLinkedListNode, FlywheelKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, FlywheelKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, FlywheelKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;
...
- (A)component1 __attribute__((swift_name("component1()")));
- (S)component2 __attribute__((swift_name("component2()")));
...
- (A)component1 __attribute__((swift_name("component1()")));
- (S)component2 __attribute__((swift_name("component2()")));
- (FlywheelKotlinException *)component3 __attribute__((swift_name("component3()")));
...
- (A)component1 __attribute__((swift_name("component1()")));
- (FS)component2 __attribute__((swift_name("component2()")));
- (TS)component3 __attribute__((swift_name("component3()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)joinWithCompletionHandler:(void (^)(FlywheelKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("join(completionHandler:)")));
