...
package com.msabhi.jsApp.counter.domain.middleware
    ...
    override fun handle(
        ...
        when (action) {
            ...
            is ShowNotificationAction -> {
                // ShowNotificationAction is collected from the actions flow in CounterApp and
                // displayed in the UI. No further propagation needed here.
            }
